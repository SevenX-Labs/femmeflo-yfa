...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative w-full bg-gradient-to-b from-[#FFF0F3] via-[#FFF6F8] to-[#FDE8EE] px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 lg:pt-8 pb-12 sm:pb-16 flex flex-col justify-between overflow-hidden font-[family-name:var(--font-jakarta)]"
    >
